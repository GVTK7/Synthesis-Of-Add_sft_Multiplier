...
setOptMode -setupTargetSlack 0.00
setOptMode -holdTargetSlack 0.00
...
deleteAllCellPad
specifyCellPad *CLKANAQHSV* -left 4 -right 4 -top 0 -bottom 1
specifyCellPad SD* -left 2 -right 2
